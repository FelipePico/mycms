...
document.addEventListener('DOMContentLoaded', function(){
	...
	if(input_file_avatar){
		input_file_avatar.addEventListener('change', function(){
			var load_img = '<img src="'+base+'/mycms/public/static/images/loader_white.svg">';
...
function load_products(section){
	...
	var url = base + '/mycms/public/md/api/load/products/' +page_section+'?page='+page;
				...
				div += "<div class=\"product\">";
					...
					div += "<div class=\"image\">";
						div += "<div class=\"overlay\">";
							div += "<div class=\"btns\">";
								div += "<a href=\""+base+"/mycms/public/product/"+product.id+"/"+product.slug+"\"> <i class=\"fas fa-eye\"></i></a>";
								div += "<a href=\"#\"> <i class=\"fas fa-cart-plus\"></i></a>";
								div += "<a href=\"#\" onclick=\"add_to_favorites('"+product.id+"', '1'); return false;\"> <i class=\"fas fa-heart\"></i></a>";
							div += "</div>";
						div += "</div>";
						div += "<img src=\""+base+"/mycms/public/uploads/"+product.file_path+"/t_"+product.image+"\" >"
					div += "</div>";
					div += "<a href=\""+base+"/mycms/public/product/"+product.id+"/"+product.slug+"\">";
...
function add_to_favorites(object, module){
	url = base+'/mycms/public/md/api/favorites/add/'+object+'/'+module;
