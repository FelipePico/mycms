...
class ConnectController extends Controller
{
    ...
    public function postLogin(Request $request){
        ...
        if ($validator->fails()):
            ...
            if(Auth::attempt(['email' => $request->input('email'), 'password' => $request->input('password')], true)):
                ...
                return back()->withErrors($validator)->with('message', 'el correo electrónico o la contraseña son incorrectos')->with( 'typealert', 'danger');
            endif;
        endif;
    ...
    public function postRegister(Request $request){
        ...
        if ($validator->fails()):
            ...
            if($user->save()):
                ...
                su usuario se creo con exito ya puede iniciar sesión')->with( 'typealert', 'success');
            endif;
        endif;
    ...
    public function getLogout(){
        ...
        if($status == "100"):
            return redirect('/login')->with('message', '
                su usuario fue suspendido')->with( 'typealert', 'danger');
        else:
            return redirect('/');
        endif;
        ...
        if ($validator->fails()):
            ...
            if($user == "1"):
                ...
                if($u->save()):
                    ...
                    return redirect('/reset?email='.$user->email)->with('message', 'Ingrese el codigo que le hemos enviado a su correo electrónico')->with( 'typealert', 'success');
                endif;
            else:
