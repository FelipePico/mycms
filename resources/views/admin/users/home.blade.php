		...
		<div class="inside">
					...
					<div class="dropdown" >
						<button class="btn btn-primary dropdown-toggle" type="button" id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false" style="width: 100%;">
  						...
  						<ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
						    <li><a class="dropdown-item" href="{{ url('/admin/users/all') }}"><i class="fas fa-stream"></i> Todos</a></li>
						    <li><a class="dropdown-item" href="{{ url('/admin/users/0') }}"><i class="fas fa-unlink"></i> No verificados</a></li>
						    <li><a class="dropdown-item" href="{{ url('/admin/users/1') }}"><i class="fas fa-user-check"></i> Verificados</a></li>
						    <li><a class="dropdown-item" href="{{ url('/admin/users/100') }}"><i class="fas fa-user-slash"></i> Suspendidos</a></li>
					  	</ul>
					</div>
			 	</div>
			</div>
			...
			<table class="table mtop16">
				...
				<tbody>
					...
					@endforeach
					<!--<tr>
						<td colspan="6">$users->render()</td> esto va dentro de llaves 
					</tr>-->
				</tbody>
			</table>
		</div>
